                ...
                <Dialog.Panel className="bg-[#fff] w-full max-w-md transform overflow-hidden rounded-2xl p-6 text-left align-middle shadow-xl transition-all z-[999]">
                  ...
                  >
                    <div className="flex gap-[10px] flex-col w-full pb-[20px]">
                      <h1 className="text-[#333] text-[15px] font-[500] bg-[#d8d8d8] w-full text-center py-[9px] rounded-[4px] opacity-[0.5]">📍Lokatsiyani yuborish</h1>
                      <h1 className="text-[#333] text-[15px] font-[500] bg-[#d8d8d8] w-full text-center py-[9px] rounded-[4px]">❤️ Sevimlilar</h1>
                      <h1 className="text-[#333] text-[15px] font-[500] bg-[#d8d8d8] w-full text-center py-[9px] rounded-[4px] opacity-[0.5]">🔙 Ortga</h1>
                    </div>
                  </Dialog.Title>
                  <div className="w-full flex justify-center flex-col gap-[12px] mt-[24px]">
                    <h1 className="text-center text-[#555] text-[18px] font-[400]">
